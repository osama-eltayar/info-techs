    ...
    <div class="content-side">
        ...
        <div class="container-fluid bg-blue">
            <div class="content-body">
                ...
                {{$owner->courses->links()}}
                <form action="{{route('admin.owners.courses.export.excel',$owner->id)}}" method="POST" id="courses-export-excel-form">
                    @csrf
                </form>
                <form action="{{route('admin.owners.courses.export.pdf',$owner->id)}}" method="POST" id="courses-export-pdf-form">
                    @csrf
                </form>
