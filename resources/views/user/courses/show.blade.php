                ...
                <div class="row">
                    <div class="col-xl-9 col-lg-8 col-12">
                        <div class="top-fav text-right">
                            ...
                            <button class="btn btn-fave" type="button"> Add to favorite <i class="fa-solid fa-heart"></i></button>
                        </div>
                            ...
                            <div class="card-info">
                                ...
                                <div class="box-info">
                                    ...
                                    @foreach($course->people as $person)
                                        <div>
                                            <p>{{$person->title}} {{$person->name}} <span>({{$person->speciality}})</span></p>
                                        </div>
                                    @endforeach
s
                                </div>
                                ...
                                <div class="box-info">
                                    ...
                                    @foreach($course->speakers as $speaker)
                                        ...
                                        <div class="right-side-box">
                                            <p>{{$speaker->title}} {{$speaker->name}} <span>({{$speaker->speciality->name}})</span></p>
                                        </div>
                                    @endforeach
                                ...
                                <div class="box-info">
                                    ...
                                    @foreach($course->materials as $material)
                                        <div class="row">
                                            <div class="col-6"><p><i class="fa-solid fa-files"></i> {{$material->name}}.{{$material->mime_type}} <small>1 MB</small></p></div>
                                            <div class="col-6"><a href="{{$material->download_url}}"><i class="fa-solid fa-angles-down"></i> download</a></div>
                                        </div>
                                    @endforeach
